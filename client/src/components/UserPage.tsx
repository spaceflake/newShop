import { Box, Button, Checkbox, FormControlLabel, Grid, List, Typography } from "@mui/material";
...
export default function UserPage() {
    ...
    const [userOrdersdeliveryAddress, setUserOrdersdeliveryAddress] = useState<any[]>([]);
    console.log(user?.id);
